...
student_1.set_name('Рома Горохов Иванович')
student_1.set_age(23)
student_1.set_mark([2,3,4])
student_1.set_home_address('Ревалюционная 55')
...
# sport_car.set_stamp('Lada')
# sport_car.set_model(567)
# sport_car.set_year_release(1999)
# sport_car.set_mileage(890)
